...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'van_security.password_encoder' => 'getVanSecurity_PasswordEncoderService',
            'van_security.password_resetter' => 'getVanSecurity_PasswordResetterService',
            'van_security.token_generator' => 'getVanSecurity_TokenGeneratorService',
    ...
    {
        $this->services['assetic.filter.compass'] = $instance = new \Assetic\Filter\CompassFilter('D:/Windows/Ruby22-x64/bin/compass', 'D:\\Windows\\Ruby22-x64\\bin\\ruby.exe');
    ...
    {
        $this->services['assetic.filter.sass'] = $instance = new \Assetic\Filter\Sass\SassFilter('D:\\Windows\\Ruby22-x64\\bin\\sass', 'D:\\Windows\\Ruby22-x64\\bin\\ruby.exe');

        $instance->setTimeout(NULL);
        $instance->setStyle(NULL);
        $instance->setCompass(NULL);
        $instance->setLoadPaths(array(0 => ($this->targetDirs[3].'\\app/../web')));
        $instance->setCacheLocation(__DIR__);
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'sass' => 'assetic.filter.sass', 'compass' => 'assetic.filter.compass'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'social-geeks', 'user' => 'root', 'password' => 'b2c3d4e5', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Van\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Van\\BookmarkBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'Van\\UserBundle\\Entity');
        $c->addDriver($b, 'Van\\BookmarkBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'VanUserBundle' => 'Van\\UserBundle\\Entity', 'VanBookmarkBundle' => 'Van\\BookmarkBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_036fd0e375953e1a04be20f1e59b407420a321b208e0e134e6af2802136833b2');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Van\\UserBundle\\Entity\\User' => $this->get('van_security.password_encoder')));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/lost-password');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reset-password');
        ...
        $s = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $o, '/login', false);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $p, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $o, 'main', $q, $r, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $g, 'main', $s, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5763ebf1054405.88556134', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker.main'), 'main', $h, $a, '_want_to_be', 'ROLE_ALLOWED_TO_SWITCH', $d), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $h, $n, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $o, 'main', $s, NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Van\\UserBundle/Resources/views'), 'VanUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Van\\SecurityBundle/Resources/views'), 'VanSecurity');
        $instance->addPath(($this->targetDirs[3].'\\src\\Van\\BookmarkBundle/Resources/views'), 'VanBookmark');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5a11cf72cb7111d1cbb7b03b59479380a99b6e85');
    }
    ...
    /**
     * Gets the 'van_security.password_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Van\SecurityBundle\Service\PasswordEncoder A Van\SecurityBundle\Service\PasswordEncoder instance.
     */
    protected function getVanSecurity_PasswordEncoderService()
    {
        return $this->services['van_security.password_encoder'] = new \Van\SecurityBundle\Service\PasswordEncoder();
    }

    /**
     * Gets the 'van_security.password_resetter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Van\SecurityBundle\Service\PasswordResetter A Van\SecurityBundle\Service\PasswordResetter instance.
     */
    protected function getVanSecurity_PasswordResetterService()
    {
        return $this->services['van_security.password_resetter'] = new \Van\SecurityBundle\Service\PasswordResetter($this->get('doctrine.orm.default_entity_manager'), $this->get('van_security.token_generator'), $this->get('swiftmailer.mailer.default'));
    }

    /**
     * Gets the 'van_security.token_generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Van\SecurityBundle\Service\TokenGenerator A Van\SecurityBundle\Service\TokenGenerator instance.
     */
    protected function getVanSecurity_TokenGeneratorService()
    {
        return $this->services['van_security.token_generator'] = new \Van\SecurityBundle\Service\TokenGenerator();
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Van\\UserBundle\\Entity\\User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VanUserBundle' => 'Van\\UserBundle\\VanUserBundle',
                'VanSecurityBundle' => 'Van\\SecurityBundle\\VanSecurityBundle',
                'VanBookmarkBundle' => 'Van\\BookmarkBundle\\VanBookmarkBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'social-geeks',
            'database_user' => 'root',
            'database_password' => 'b2c3d4e5',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '5a11cf72cb7111d1cbb7b03b59479380a99b6e85',
            'ruby.bin' => 'D:\\Windows\\Ruby22-x64\\bin\\ruby.exe',
            'sass.bin' => 'D:\\Windows\\Ruby22-x64\\bin\\sass',
            'compass.bin' => 'D:/Windows/Ruby22-x64/bin/compass',
            'locale' => 'en',
            ...
            'kernel.secret' => '5a11cf72cb7111d1cbb7b03b59479380a99b6e85',
            ...
            'assetic.node.bin' => 'D:\\Server\\nodejs\\\\node.EXE',
            'assetic.ruby.bin' => 'D:\\Windows\\Ruby22-x64\\bin\\ruby.exe',
            'assetic.sass.bin' => '/usr/bin/sass',
            'assetic.reactjsx.bin' => '/usr/bin/jsx',
            'assetic.filter.cssrewrite.class' => 'Assetic\\Filter\\CssRewriteFilter',
            'assetic.filter.sass.class' => 'Assetic\\Filter\\Sass\\SassFilter',
            'assetic.filter.sass.bin' => 'D:\\Windows\\Ruby22-x64\\bin\\sass',
            ...
            'assetic.filter.compass.bin' => 'D:/Windows/Ruby22-x64/bin/compass',
